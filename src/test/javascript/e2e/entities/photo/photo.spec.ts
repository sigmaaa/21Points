...
describe('Photo e2e test', () => {
  ...
  it('should load Photos', async () => {
    ...
    expect(await photoComponentsPage.getTitle()).to.eq('Photos');
  });

  it('should load create Photo page', async () => {
    await photoComponentsPage.clickOnCreateButton();
    photoUpdatePage = new PhotoUpdatePage();
    expect(await photoUpdatePage.getPageTitle()).to.eq('Create or edit a Photo');
  ...
  it('should create and save Photos', async () => {
    ...
    expect(await photoUpdatePage.getUploadedInput()).to.contain('2001-01-01T02:30', 'Expected uploaded value to be equals to 2000-12-31');
  ...
  it('should delete last Photo', async () => {
    ...
    expect(await photoDeleteDialog.getDialogTitle()).to.eq('Are you sure you want to delete this Photo?');
